<?php /*?><div class="content-box <?php echo (($search_flag==0)?'closed-box':'');?>"><!-- Start Content Box -->
	...
	<div class="content-box-content">
		...
		<div style="display: block;" class="" id="tab">
			...
			<fieldset> 
				...
				<p>
					<label>Buyer / Provider</label>
					<?php  echo ($this->Form->input('first_name', array('type'=>'text', 'div'=>false, 'label'=>false, "class" => "text-input small-input")));?>
				</p>
...
<div class="content-box"><!-- Start Content Box -->
	...
	<div class="content-box-header">
		...
		<h3 style="cursor: s-resize;"><?php echo $string = ltrim(preg_replace('/[A-Z]/', ' $0', $model))." list of user"; ?></h3>
		<ul class="content-box-tabs">
	...
	<div class="content-box-content">
		...
		<div class="tab-content<?php echo ($defaultTab==$tab?' default-tab':'');?>" id="<?php echo ($tab);?>"> <!-- This is the target div. id must match the href of this div's tab -->
			...
			<div id="target<?php echo ($tab);?>"><?php
					echo ($defaultTab==$tab?$this->element('Admin/'.$model.'/table_user_violation_list'):'');
			?></div>
