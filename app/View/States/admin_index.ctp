<div class="content-box <?php echo (($search_flag==0)?'closed-box':'');?>"><!-- Start Content Box -->
	...
	<div class="content-box-content">
		...
		<div style="display: block;" class="" id="tab">
			...
			<?php echo ($this->Form->create('State', array('id'=>'SearchForm', 'url'=>array('admin'=>true, 'controller' => 'states', 'action' => 'index'), 'onsubmit'=>'javascript: return true;')));?>
				
				<fieldset> 
								
				<p>
					<label>Country</label>
					<?php  echo ($this->Form->input('country_id', array('div'=>false, 'label'=>false, "class" => "text-input small-input",'options'=>$countries,'empty'=>'-- Select Country -- ')));?>
				</p>
...
<div class="content-box"><!-- Start Content Box -->
	...
	<div class="content-box-header">
		...
		<h3 style="cursor: s-resize;">Manage State</h3>
		<ul class="content-box-tabs">
	...
	<div class="content-box-content">
		...
		<?php
		echo $this->Form->create('State', array('name'=>'State', 'url' => array('action' => 'process')));
		...
		<div class="tab-content<?php echo ($defaultTab==$tab?' default-tab':'');?>" id="<?php echo ($tab);?>"> <!-- This is the target div. id must match the href of this div's tab -->
			...
			<div id="target<?php echo ($tab);?>"><?php
					echo ($defaultTab==$tab?$this->element('Admin/State/table'):'');
			?></div>
