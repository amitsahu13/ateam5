...
<div style="width: 670px; margin: 5px 0pt; padding: 20px; background-repeat: no-repeat; border: 5px solid #0160AF; background-color: rgb(125, 184, 245);">
...
<?php if (Configure::read('footers')!=''){ ?>
<table width="100%">
    <tbody >
	<?php $arr = (Configure::read('footers'));
	 //pr($arr); die;
		foreach($arr as $footer){ ?>
		<tr>
			<td style="center; font-size: 11px; color: rgb(146, 146, 146);">
			<?php echo $footer; ?>
			</td>
		</tr>
	<?php } ?>
