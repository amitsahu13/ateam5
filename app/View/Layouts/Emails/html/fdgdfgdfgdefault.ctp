...
<div style="width: 670px; margin: 5px 0pt; padding: 20px; background-repeat: no-repeat; border: 5px solid #ED1F24; background-color: rgb(192, 192, 192);">
...
<table width="720px" border="0" cellspacing="0" cellpadding="0">
    <tbody>
        <tr>
            <td>
            <p style="text-align: center;">Delivered by <a href="<?php echo Configure::read('App.SiteUrl'); ?>" style="color: rgb(237, 31, 36);" title="<?PHP echo Configure::read('Site.title'); ?>" target="_blank"><?PHP echo Configure::read('Site.title'); ?></a></p>
            </td>
        </tr>
    </tbody>
</table>
