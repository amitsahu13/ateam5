...
<?php	
	...
	echo $this->Html->css(array('style','jquery.powertip','jquery.selectbox'));
?>
<!--[if lt IE 9]>
...
<div id="wrapper">
    <div id="container">
		<div class="left_sidebar">
			<?php echo $this->element("Front/left_sidebar_blog"); ?>
		</div>
        <div class="right_sidebar" style="margin-bottom:-10px;">
