...
<html>
	<head>
	  ...
	  <script type="text/javascript">
		  ...
		  var CurrentUrl = "<?php echo Router::url(array('controller'=>$this->params['controller'], 'action'=>$this->params['action'],isset($this->params->params['pass'][0])?$this->params->params['pass'][0]:''));?>";
	...
	<body>
		<div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
			...
			<div id="sidebar"><div id="sidebar-wrapper"> <!-- Sidebar with logo and menu -->
				...
				<?php 
					echo $this->Html->link($this->Html->image('logo.png', array('width'=>'213','id'=>'logo')), array('controller'=>'admins','action'=>'dashboard'), array('escape'=>false));
				?>
				
			  
				<!-- Sidebar Profile links -->
				<div id="profile-links">
					Hello, <?php echo ($this->Html->link($this->Session->read('Auth.User.first_name'),array('controller'=>'admins','action'=>'edit',$this->Session->read('Auth.User.id')),array('title'=>'Edit your profile')));?>
			...
			<div id="main-content"> <!-- Main Content Section with everything -->
				...
				<!-- Page Head -->
				<h2><?php echo $string = ltrim(preg_replace('/[A-Z]/', ' $0', $title_for_layout)); ?></h2>
