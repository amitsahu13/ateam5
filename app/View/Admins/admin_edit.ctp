<div class="content-box"><!-- Start Content Box -->
	...
	<div class="content-box-header">
		...
		<h3 style="cursor: s-resize;"><?php echo ($this->params['pass'][0] != $this->Session->read('Auth.User.id') ? 'Edit User Profile' : 'Your Profile'); ?></h3>
	...
	<div class="content-box-content">
		...
		<div style="display: block;" class="" id="tab2">
			...
			'inputDefaults' => array(
				...
				<?php echo ($this->element('Admin/Admin/edit_form'));?>
