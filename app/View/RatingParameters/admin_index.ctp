	...
	<div class="content-box-content">
		...
		<div style="display: block;" class="" id="tab">
			...
			<fieldset> 
				...
				<p>
					<?php  echo ($this->Form->input('name', array('type'=>'text', 'div'=>false, 'label'=>false, "class" => "text-input small-input", 'label'=>'Name')));?>
				</p>
				<p>
					<label>Rating User Type</label>
					<?php  echo ($this->Form->input('type', array('options'=>Configure::read('App.RatingType'),'empty'=>'All','div'=>false, 'label'=>false, "class" => "small-input")));?> 
