...
<table>				
	...
	<tfoot>
			...
			<td colspan="7">
				...
				<div class="bulk-actions align-left" style='float:right'><?php //echo $this->Html->link("Add New Job", array('admin'=>true, 'controller'=>''.$controller.'', 'action'=>'add',$project_id), array("class"=>"button", "escape"=>false)); ?></div>
	...
	<tbody>
		...
		<tr <?php echo ($alt==0)?'class="alt-row"':''; $alt=!$alt;?>>
			...
			<td><b><a href="javascript:void(0);"><?php echo $value[''.$model.'']['title'];?></a><?php 
				//echo $this->Html->link($value[''.$model.'']['title'],array('controller'=>'jobs','action'=>'view',$value[''.$model.'']['id']));
				?></b>
			</td>
