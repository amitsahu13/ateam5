...
<table>
	...
	<thead>
		<tr>	
			...
			?>
			<th>
			<?php echo ($this->ExPaginator->sort("Buyer.first_name", 'Buyer'));?>
			</th>
			<th>
			<?php echo ($this->ExPaginator->sort("Provider.first_name", 'Provider')); ?>
			</th>
			<?php
			}
			else
			...
			echo ($this->ExPaginator->sort("$type_go.first_name", $type_go));
			?></th>
			<?php
			}
			?>
	...
	<tbody>
		...
		<tr <?php echo ($alt==0)?'class="alt-row"':''; $alt=!$alt;?>>
			...
			<td>
			<b>
				<?php echo $value['Buyer']['first_name'];?>
			</b></td>
			
			<td>
			<b>
				<?php echo $value['Provider']['first_name'];?>
			</b></td>
			<?php
			}
			else
			...
			<td>
			<b>
				<?php echo $value[$type_go]['first_name'];?>
			</b></td>
			<?php
			}
			?>
