...
<table>
	...
	<tbody>
		...
		<tr <?php echo ($alt==0)?'class="alt-row"':''; $alt=!$alt;?>>
			...
			<td>
			<b>
				<?php echo ($this->Html->link($this->General->wrap_long_txt($value['Buyer']['first_name'],0,50),array('action'=>'user_violation_list','b',$value['Buyer']['id']),array('title'=>'View All Violations')));?>
			</b></td>
			<td>
			<b>
				<?php echo ($this->Html->link($this->General->wrap_long_txt($value['Provider']['first_name'],0,50),array('action'=>'user_violation_list','p',$value['Provider']['id']),array('title'=>'View All Violations')));?>
			</b></td>
			<td>
			<b>
