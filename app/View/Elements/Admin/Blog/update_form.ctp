<fieldset>
	...
	<p>
		<?php  echo ($this->Form->input('article', array(
													'div'=>false,
													'label'=>'Content*',
													"class" => "text-input text-area ckeditor",
													'rows'=>'30'
													)));?> 
	</p>
	<p>
	<?php
		$file_path= BLOG_IMAGE_SMALL_PATH.'small_'.$this->request->data['Blog']['post_img'];
		if(file_exists($file_path)){
			echo $this->Html->image(BLOG_IMAGE_SMALL.'small_'.$this->request->data['Blog']['post_img']);
		}
	?>
	<?php  echo ($this->Form->input('post_img', array('type'=>'file',
													  'div'=>false,
													  'label'=>'Post Image*', 
													  "class" => "text-input"
													  )));
	...
	<p>
		<?php  echo ($this->Form->input('meta_title', array('div'=>false,
															'label'=>'Meta Title*',
	...
	<p>
		<?php  echo ($this->Form->input('meta_keywords', array('div'=>false, 
																'label'=>'Meta Keywords*',
																"class" => "text-input small-input"
																)));?> 
	</p>
