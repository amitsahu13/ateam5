...
?>
		<div class="blog3_bottom">
			...
			<div class="blog3_right">
				...
				<div class="rply_cmnt rply_top_bdr">
				<div class="cmt_user"></div>
				<div class="cmt_right">
				<h3>James Bond</h3>
				<div class="cmnt_time">25th Jan 2013 10.00PM</div>
				<p>Hello Peter</p>
				</div>				
				</div>
				...
				<div class="rply_cmnt rply_btm_bdr">
				<div class="cmt_user"></div>
				<div class="cmt_right">
				<h3>James Bond</h3>
				<div class="cmnt_time">25th Jan 2013 10.00PM</div>
				...
				<div class="whtlist_2 whtlist_margin"><p><a href="javascript:void(0);" id="reply" >Reply</a></p> </div>
