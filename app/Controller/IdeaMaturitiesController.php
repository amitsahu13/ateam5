<?php
/**
 * IdeaMaturities Controller
 *
 * PHP version 5.4
 *
 */
class IdeaMaturitiesController extends AppController {
	/**
	 * IdeaMaturities name
	 *
	 * @var string
	 * @access public
	 */
	var	$name	=	'IdeaMaturities';
	var	$uses	=	array('IdeaMaturity');
	var $helpers = array('Html','General');
	var $model='IdeaMaturity';
	var $controller='idea_maturities';
	/*
	 * beforeFilter
	 * @return void
	 */
