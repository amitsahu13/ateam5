<?php
/**
 * BusinessPlanLevels Controller
 *
 * PHP version 5.4
 *
 */
class BusinessPlanLevelsController extends AppController {
	/**
	 * BusinessPlanLevels name
	 *
	 * @var string
	 * @access public
	 */
	var	$name	=	'BusinessPlanLevels';
	var	$uses	=	array('BusinessPlanLevel');
	var $helpers = array('Html','General');
	var $model='BusinessPlanLevel';
	var $controller='business_plan_levels';
	/*
	 * beforeFilter
	 * @return void
	 */
