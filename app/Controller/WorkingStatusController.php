<?php
/**
 * WorkingStatus Controller
 *
 * PHP version 5.4
 *
 */
class WorkingStatusController extends AppController {
	/**
	 * WorkingStatus name
	 *
	 * @var string
	...
	var	$uses	=	array('WorkingStatus');
	var $helpers = array('Html','General');
	var $model='WorkingStatus';
	var $controller='working_status';
	/*
	 * beforeFilter
	 * @return void
	 */
