<?php
/**
 * Job Direction Controller
 *
 * PHP version 5.4
 *
 */
class JobDirectionsController extends AppController {
	/**
	 * Agreements name
	 *
	 * @var string
	 * @access public
	 */
	var	$name		= 'JobDirections';
	var	$uses		= array('JobDirection');
	var $helpers 	= array('Html','General');
	var $model		= 'JobDirection';
	var $controller	= 'job_directions';
	/*
	 * beforeFilter
	 * @return void
	 */
