<?php
/**
 * LawJurisdictions Controller
 *
 * PHP version 5.4
 *
 */
class LawJurisdictionsController extends AppController {
	/**
	 * LawJurisdictions name
	 *
	 * @var string
	 * @access public
	 */
	var	$name	=	'LawJurisdictions';
	var	$uses	=	array('LawJurisdiction');
	var $helpers = array('Html','General');
	var $model='LawJurisdiction';
	var $controller='law_jurisdictions';
	/*
	 * beforeFilter
	 * @return void
	 */
